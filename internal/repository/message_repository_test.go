...
func TestMessageRepository_MarkRead_And_GetUnreadCount(t *testing.T) {
	...
	m1 := &domain.Message{ID: uuid.NewString(), SenderID: u1.ID, RecipientID: u2.ID, Content: strPtr("1"), MessageType: domain.MessageTypeText, CreatedAt: time.Now(), UpdatedAt: time.Now()}
	m2 := &domain.Message{ID: uuid.NewString(), SenderID: u1.ID, RecipientID: u2.ID, Content: strPtr("2"), MessageType: domain.MessageTypeText, CreatedAt: time.Now(), UpdatedAt: time.Now()}
	m3 := &domain.Message{ID: uuid.NewString(), SenderID: u2.ID, RecipientID: u1.ID, Content: strPtr("3"), MessageType: domain.MessageTypeText, CreatedAt: time.Now(), UpdatedAt: time.Now()}
...
func TestMessageRepository_GetConversations_OrderAndUnread(t *testing.T) {
	...
	mA := &domain.Message{ID: uuid.NewString(), SenderID: u1.ID, RecipientID: u2.ID, Content: strPtr("a"), MessageType: domain.MessageTypeText, CreatedAt: time.Now().Add(-3 * time.Minute), UpdatedAt: time.Now().Add(-3 * time.Minute)}
	mB := &domain.Message{ID: uuid.NewString(), SenderID: u2.ID, RecipientID: u1.ID, Content: strPtr("b"), MessageType: domain.MessageTypeText, CreatedAt: time.Now().Add(-2 * time.Minute), UpdatedAt: time.Now().Add(-2 * time.Minute)}
	mC := &domain.Message{ID: uuid.NewString(), SenderID: u1.ID, RecipientID: u3.ID, Content: strPtr("c"), MessageType: domain.MessageTypeText, CreatedAt: time.Now().Add(-1 * time.Minute), UpdatedAt: time.Now().Add(-1 * time.Minute)}
