...
func TestCreatePost(t *testing.T) {
	t.Run("successful post creation", func(t *testing.T) {
		...
		_, err := svc.createPost(context.Background(), "test-jwt", "did:plc:test", "Hello world!", nil)
		require.NoError(t, err)
	})
	...
	t.Run("with embed", func(t *testing.T) {
		...
		_, err := svc.createPost(context.Background(), "test-jwt", "did:plc:test", "Post with embed", embed)
		require.NoError(t, err)
	})
	...
	t.Run("returns error on server error", func(t *testing.T) {
		...
		_, err := svc.createPost(context.Background(), "test-jwt", "did:plc:test", "Hello", nil)
		require.Error(t, err)
	...
	t.Run("returns error when PDS URL empty", func(t *testing.T) {
		...
		_, err := svc.createPost(context.Background(), "jwt", "did:plc:test", "Hello", nil)
		require.Error(t, err)
		assert.Contains(t, err.Error(), "missing PDS URL")
	})
}
