...
func NewChannelService(channelRepo ChannelRepository, userRepo UserRepository) *ChannelService {
...
func (s *ChannelService) CreateChannel(ctx context.Context, userID uuid.UUID, req domain.ChannelCreateRequest) (*domain.Channel, error) {
	// Validate request
...
func (s *ChannelService) GetChannel(ctx context.Context, id uuid.UUID) (*domain.Channel, error) {
...
func (s *ChannelService) ListChannels(ctx context.Context, params domain.ChannelListParams) (*domain.ChannelListResponse, error) {
	return s.channelRepo.List(ctx, params)
}

// UpdateChannel updates a channel
func (s *ChannelService) UpdateChannel(ctx context.Context, userID, channelID uuid.UUID, updates domain.ChannelUpdateRequest) (*domain.Channel, error) {
	// Validate request
...
func (s *ChannelService) GetUserChannels(ctx context.Context, userID uuid.UUID) ([]domain.Channel, error) {
	return s.channelRepo.GetChannelsByAccountID(ctx, userID)
}

// GetChannelVideos retrieves videos for a channel
func (s *ChannelService) GetChannelVideos(ctx context.Context, channelID uuid.UUID, page, pageSize int) (*domain.VideoListResponse, error) {
...
func (s *ChannelService) EnsureDefaultChannel(ctx context.Context, userID uuid.UUID) (*domain.Channel, error) {
