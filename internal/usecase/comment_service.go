...
func (s *CommentService) CreateComment(ctx context.Context, userID uuid.UUID, req *domain.CreateCommentRequest) (*domain.Comment, error) {
	// Verify video exists
...
func (s *CommentService) GetComment(ctx context.Context, id uuid.UUID) (*domain.CommentWithUser, error) {
...
func (s *CommentService) UpdateComment(ctx context.Context, userID uuid.UUID, commentID uuid.UUID, req *domain.UpdateCommentRequest) error {
	// Verify ownership
...
func (s *CommentService) DeleteComment(ctx context.Context, userID uuid.UUID, commentID uuid.UUID, isAdmin bool) error {
...
func (s *CommentService) ListComments(ctx context.Context, videoID uuid.UUID, parentID *uuid.UUID, limit, offset int, orderBy string) ([]*domain.CommentWithUser, error) {
	// Verify video exists
...
func (s *CommentService) FlagComment(ctx context.Context, userID uuid.UUID, commentID uuid.UUID, req *domain.FlagCommentRequest) error {
...
func (s *CommentService) UnflagComment(ctx context.Context, userID uuid.UUID, commentID uuid.UUID) error {
...
func (s *CommentService) GetCommentFlags(ctx context.Context, commentID uuid.UUID, userID uuid.UUID, isAdmin bool) ([]*domain.CommentFlag, error) {
...
func (s *CommentService) ModerateComment(ctx context.Context, userID uuid.UUID, commentID uuid.UUID, status domain.CommentStatus, isAdmin bool) error {
