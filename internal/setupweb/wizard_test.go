...
JWT_SECRET=SENTINEL-JWT-b3JlbGx5
MFA_KEY_KEK=SENTINEL-KEK-b3JlbGx5MDAwMDAwMDAwMDAwMDA=
POSTGRES_USER=vidra
POSTGRES_PASSWORD=SENTINEL-PG-deadbeef
REDIS_PASSWORD=SENTINEL-REDIS-deadbeef
SEARCH_INTERNAL_SECRET=SENTINEL-SEARCH-deadbeef
STORAGE_BACKEND=s3
...
var sentinels = []string{
	"SENTINEL-JWT-b3JlbGx5",
	"SENTINEL-KEK-b3JlbGx5MDAwMDAwMDAwMDAwMDA=",
	"SENTINEL-PG-deadbeef",
	"SENTINEL-REDIS-deadbeef",
	"SENTINEL-SEARCH-deadbeef",
