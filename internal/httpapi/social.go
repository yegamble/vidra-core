...
func (h *SocialHandler) Unfollow(w http.ResponseWriter, r *http.Request) {
	...
	if followerDID == "" {
		WriteError(w, http.StatusBadRequest, errors.New("follower_did required"))
		return
	}
...
func (h *SocialHandler) GetFollowers(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		WriteError(w, http.StatusInternalServerError, fmt.Errorf("failed to get followers: %w", err))
		return
	}
...
func (h *SocialHandler) GetFollowing(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		WriteError(w, http.StatusInternalServerError, fmt.Errorf("failed to get following: %w", err))
		return
	}
...
func (h *SocialHandler) GetLikes(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		WriteError(w, http.StatusInternalServerError, fmt.Errorf("failed to get likes: %w", err))
		return
	}
...
func (h *SocialHandler) GetComments(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		WriteError(w, http.StatusInternalServerError, fmt.Errorf("failed to get comments: %w", err))
		return
	}
...
func (h *SocialHandler) GetCommentThread(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		WriteError(w, http.StatusInternalServerError, fmt.Errorf("failed to get thread: %w", err))
		return
	}
...
func (h *SocialHandler) ApplyLabel(w http.ResponseWriter, r *http.Request) {
	...
	WriteJSON(w, http.StatusOK, map[string]string{"status": "label_applied"})
}
...
func (h *SocialHandler) RemoveLabel(w http.ResponseWriter, r *http.Request) {
	...
	WriteJSON(w, http.StatusOK, map[string]string{"status": "label_removed"})
}
...
func (h *SocialHandler) GetLabels(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		WriteError(w, http.StatusInternalServerError, fmt.Errorf("failed to get labels: %w", err))
		return
	}
