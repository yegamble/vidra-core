...
func (m *MockCommentRepoForFeed) ListAll(ctx context.Context, opts domain.AdminCommentListOptions) ([]*domain.CommentWithUser, int64, error) {
	args := m.Called(ctx, opts)
	if args.Get(0) == nil {
...
func (m *MockCommentRepoForFeed) Approve(ctx context.Context, id uuid.UUID) error {
	return m.Called(ctx, id).Error(0)
}
func (m *MockCommentRepoForFeed) BulkRemoveByAccount(ctx context.Context, accountName string) (int64, error) {
