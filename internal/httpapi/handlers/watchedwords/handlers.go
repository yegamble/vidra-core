...
func (h *Handlers) updateWatchedWordList(w http.ResponseWriter, r *http.Request, internalError string) {
	...
	if err != nil {
		...
		shared.WriteError(w, http.StatusInternalServerError, errors.New(internalError))
		return
	}
