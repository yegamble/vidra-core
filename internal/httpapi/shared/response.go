...
var (
	...
	errorToStatusMappings = []struct {
	...
	}{
		{
			...
			errors: []error{domain.ErrNotFound, domain.ErrUserNotFound, domain.ErrVideoNotFound, domain.ErrMessageNotFound, domain.ErrConversationNotFound, domain.ErrWatchedWordListNotFound, domain.ErrAutoTagPolicyNotFound, domain.ErrStudioJobNotFound, domain.ErrMigrationNotFound},
		},
		{
		...
		},
		{
			...
			errors: []error{domain.ErrValidation, domain.ErrBadRequest, domain.ErrInvalidFormat, domain.ErrInvalidChunk, domain.ErrCannotMessageSelf, domain.ErrMessageTooLong, domain.ErrInvalidMessageType, domain.ErrInvalidStudioTask, domain.ErrMigrationCantCancel, domain.ErrMigrationValidation},
		},
		{
			status: http.StatusConflict,
			errors: []error{domain.ErrConflict, domain.ErrUserAlreadyExists, domain.ErrStudioJobInProgress, domain.ErrMigrationInProgress},
		},
		{
