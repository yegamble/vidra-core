...
func (s *Server) Handler() http.Handler {
	...
	r.Get("/setup/quickinstall", wizard.HandleQuickInstall)
	r.Post("/setup/quickinstall", wizard.HandleQuickInstall)
	...
	r.Get("/setup/email", wizard.HandleEmail)
	r.Post("/setup/email", wizard.HandleEmail)
	r.Post("/setup/test-email", wizard.HandleTestEmail)
