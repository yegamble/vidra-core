...
func loadCommonFields(cfg *Config, setupMode bool) {
	loadIPFSFields(cfg, setupMode)
	loadIOTAFields(cfg)
	loadStorageFields(cfg, setupMode)
	loadBackupFields(cfg)
	loadUploadAndProcessingFields(cfg)
	loadRateLimitFields(cfg)
	loadCORSFields(cfg)
	loadLoggingFields(cfg)
	loadHealthCheckFields(cfg)
	loadVideoEncodingFields(cfg)
	loadHLSFields(cfg)
	loadStorageTierFields(cfg)
	loadPinningFields(cfg)
	loadSessionFields(cfg)
	loadAPIFields(cfg)
	loadValidationFields(cfg)
	loadEncodingSchedulerFields(cfg)
	loadWhisperFields(cfg)
	loadATProtoFields(cfg, setupMode)
	loadNginxFields(cfg)
	loadFederationFields(cfg, setupMode)
	loadActivityPubFields(cfg)
	loadLiveStreamingFields(cfg)
	loadFFmpegFields(cfg)
	loadReplayFields(cfg, setupMode)
	loadTorrentFields(cfg, setupMode)
	loadDHTFields(cfg, setupMode)
	loadSmartSeedingFields(cfg, setupMode)
	loadHybridDistributionFields(cfg, setupMode)
	loadEmailFields(cfg)
	loadVirusScanFields(cfg, setupMode)
...
func loadIPFSFields(cfg *Config, setupMode bool) {
...
func loadIOTAFields(cfg *Config) {
...
func loadStorageFields(cfg *Config, setupMode bool) {
...
func loadBackupFields(cfg *Config) {
...
func loadUploadAndProcessingFields(cfg *Config) {
...
func loadRateLimitFields(cfg *Config) {
...
func loadCORSFields(cfg *Config) {
...
func loadLoggingFields(cfg *Config) {
	cfg.LogLevel = GetEnvOrDefault("LOG_LEVEL", "info")
	cfg.LogFormat = GetEnvOrDefault("LOG_FORMAT", "json")
}

func loadHealthCheckFields(cfg *Config) {
...
func loadVideoEncodingFields(cfg *Config) {
...
func loadPinningFields(cfg *Config) {
...
func loadValidationFields(cfg *Config) {
...
func loadEncodingSchedulerFields(cfg *Config) {
...
func loadWhisperFields(cfg *Config) {
...
func loadATProtoFields(cfg *Config, setupMode bool) {
...
func loadNginxFields(cfg *Config) {
...
func loadFederationFields(cfg *Config, setupMode bool) {
...
func loadActivityPubFields(cfg *Config) {
...
func loadLiveStreamingFields(cfg *Config) {
...
func loadFFmpegFields(cfg *Config) {
	cfg.FFmpegPath = GetEnvOrDefault("FFMPEG_PATH", "ffmpeg")
...
func loadReplayFields(cfg *Config, setupMode bool) {
...
func loadTorrentFields(cfg *Config, setupMode bool) {
...
func loadDHTFields(cfg *Config, setupMode bool) {
...
func loadSmartSeedingFields(cfg *Config, setupMode bool) {
...
func loadHybridDistributionFields(cfg *Config, setupMode bool) {
...
func loadEmailFields(cfg *Config) {
...
func loadVirusScanFields(cfg *Config, setupMode bool) {
