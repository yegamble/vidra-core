...
type SubscriptionRepository interface {
	...
	ListUserSubscriptions(ctx context.Context, subscriberID uuid.UUID, limit, offset int, sortBy ...string) (*domain.SubscriptionResponse, error)
	...
	ListSubscriptions(ctx context.Context, subscriberID string, limit, offset int, sort ...string) ([]*domain.User, int64, error)
