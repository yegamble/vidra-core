...
.PHONY: act-test
act-test: ## Run primary GitHub Actions jobs locally with act
	act push -W .github/workflows/test.yml -j unit --container-architecture linux/amd64
	act push -W .github/workflows/test.yml -j lint --container-architecture linux/amd64
