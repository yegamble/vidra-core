...
| Source table | Rows there | What is lost |
|---|---:|---|
| `videoChapter` | 20,500 | chapter markers |
| `accountVideoRate` | 18,895 | likes / dislikes |
| `actorImage` | 12,883 | account + channel avatars and banners |
| `storyboard` | 1,564 | regenerated by Vidra, so no real loss |
